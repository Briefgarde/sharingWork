...
import ch.hearc.ig.serie2.Menu;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            // OOOOOOOOOO CA FONCTIONNE
    public static String pathToCSV = "../test2.csv";

    /**
     * Permet de créer un
     *
     * @param restaurants Un set de restaurants déstiné à être fait en format CSV
     */
    private static void printRestToCSV(Set<Restaurant> restaurants){
        try (
            BufferedWriter writer = Files.newBufferedWriter(Paths.get(pathToCSV));

            CSVPrinter csvPrinter = new CSVPrinter(writer, CSVFormat.DEFAULT
                    .withHeader("Id", "Name", "Description","Type", "Website", "Address"))
        ){
            for (Restaurant rest : restaurants){
                csvPrinter.printRecord(rest.getId(),
                        rest.getName(),
                        rest.getDescription(),
                        rest.getType(),
                        rest.getWebsite(),
    ...
    private static void printMainMenu() {
        ...
        System.out.println("6. Créer un fichier CSV avec les restaurants.");
    ...
    private static void proceedMainMenu(int choice) {
        switch (choice) {
            ...
            case 5:
                ...
                break;
            case 6:
                printRestToCSV(FakeItems.getAllRestaurants());
                break;
            case 0:
